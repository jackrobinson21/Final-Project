               ...
               tabPanel("Emissions Rate by Country",
                        sidebarLayout(
                          ...
                          mainPanel(
                            ...
                            h2("Description"),
                            p("This line graph shows the amount of emissions per country since 1970. It includes data from various types pf greenhouse gas emissions such as CO2, N2O, and CH4.
               ...
               tabPanel("Sector Emissions",
                        sidebarLayout(
                          ...
                          mainPanel(
                            plotOutput("bargraph"),
                            h2("Description:"),
                            p("This bar graph illustrates CO2 emissions per country in various industries such as power, building electricity, transportation, and others. In all of the bar graphs, we can observe that the United States and China have overwhelmingly higher emissions than
                              any other countries. ")
                          )
                        )
                        ),
